...
import com.example.myshop.model.CategoryDTO;
...
public class CategoryController {
    ...
    public String add(Model model){
        ...
        return "/admin/categories/saveOrUpdate";
    }
    ...
    public ModelAndView edit(ModelMap model, @PathVariable("categoryId") Integer categoryId){
        ...
        if (opt.isPresent()){
            ...
            return new ModelAndView("/admin/categories/saveOrUpdate", model) ;
        }
    ...
    public ModelAndView delete(@PathVariable("categoryId") Integer categoryId, ModelMap model){
    ...
    public ModelAndView saveOrUpdate(ModelMap model, @Valid @ModelAttribute("category") CategoryDTO dto, BindingResult result){
        if (result.hasErrors()){
            return new ModelAndView("admin/categories/saveOrUpdate");
        }
